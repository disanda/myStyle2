...
def get_arg_parser():
    ...
    generate_images_parser = subparsers.add_parser('generate_images', help='Generate images')
    ...
    style_mixing_example_parser = subparsers.add_parser('style_mixing_example', help='Generate style mixing video')
